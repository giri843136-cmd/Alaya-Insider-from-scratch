...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const vals = [
      ...
      JSON.stringify(data.benefits||[]), JSON.stringify(data.pros||[]), JSON.stringify(data.cons||[]),
      data.buying_advice||'', JSON.stringify(data.specifications||{}), JSON.stringify(data.tags||[]),
