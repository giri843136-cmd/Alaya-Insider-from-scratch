...
export function seedDemoData() {
  ...
  // ── Demo product data ──────────────────────────────────────────────────────
  // price/prev/rating/reviews stay NULL on every seeded product: these columns
  // are reserved for values from an OFFICIAL Amazon Creators API source. They
  // stay NULL until such a source is connected AND display is permitted — the
  // fabricated editorial numbers that used to live here (e.g. Le Creuset
  // 4.8 / 3456 / 199.95) were removed by TASK 4 (Amazon compliance).
  const productData = [
    { name: 'Muji Aroma Diffuser', slug: 'muji-aroma-diffuser', brand: 'muji', cat: 'home', subcat: 'decor', price: null, prev: null, rating: null, reviews: null, desc: 'A beautifully minimal ultrasonic aroma diffuser that doubles as ambient lighting.', why: 'An elegant everyday diffuser combining simplicity with excellent functionality.', bestFor: 'Minimalists who want a reliable, good-looking diffuser', benefits: ['Ultra-quiet operation','Warm ambient LED light','Easy to clean','Compact design'], pros: ['Beautiful minimal design','Very quiet','Good mist output'], cons: ['Small water tank','No timer options'], featured: 1, trending: 1, editors: 0 },
    { name: 'Aesop Resurrection Hand Wash', slug: 'aesop-resurrection-hand-wash', brand: 'aesop', cat: 'beauty', subcat: 'skincare', price: null, prev: null, rating: null, reviews: null, desc: 'Gentle hand wash with orange, rosemary, and lavender essential oils.', why: 'A daily luxury that makes routine handwashing feel like a spa moment.', bestFor: 'Anyone who appreciates elevated everyday essentials', benefits: ['Botanical ingredients','Distinctive scent','Gentle on skin','Beautiful packaging'], pros: ['Incredible scent','Moisturizing formula','Iconic design'], cons: ['Premium price point'], featured: 1, trending: 0, editors: 1 },
    { name: 'Le Creuset Dutch Oven 5.5 Qt', slug: 'le-creuset-dutch-oven', brand: 'le-creuset', cat: 'home', subcat: 'kitchen', price: null, prev: null, rating: null, reviews: null, desc: 'The iconic enameled cast iron Dutch oven.', why: 'A kitchen investment that genuinely lasts a lifetime.', bestFor: 'Home cooks who want buy-it-for-life cookware', benefits: ['Lifetime durability','Even heat distribution','Versatile cooking','Beautiful presentation'], pros: ['Exceptional build quality','Gorgeous colors','Works on all heat sources'], cons: ['Heavy','Expensive'], featured: 1, trending: 1, editors: 1 },
    { name: 'Bang & Olufsen Beoplay H95', slug: 'bang-olufsen-beoplay-h95', brand: 'bang-olufsen', cat: 'electronics', subcat: 'audio', price: null, prev: null, rating: null, reviews: null, desc: 'Premium wireless headphones with adaptive ANC.', why: 'For those who want the absolute best in wireless audio.', bestFor: 'Audiophiles and design-conscious listeners', benefits: ['Exceptional sound quality','Premium materials','38-hour battery','Adaptive ANC'], pros: ['Outstanding audio clarity','Beautiful aluminum design','Incredible comfort'], cons: ['Very expensive','Bulky carrying case'], featured: 0, trending: 1, editors: 1 },
    { name: 'Away Carry-On', slug: 'away-carry-on', brand: 'away', cat: 'travel', subcat: 'luggage', price: null, prev: null, rating: null, reviews: null, desc: 'Durable polycarbonate carry-on with interior compression system.', why: 'A practical, well-designed carry-on that balances durability with smart features.', bestFor: 'Frequent travelers who want reliable, stylish luggage', benefits: ['Durable polycarbonate shell','Interior compression','Smooth spinner wheels','TSA-approved lock'], pros: ['Excellent build quality','Great interior organization','Smooth wheels'], cons: ['No external pockets','Slightly heavy'], featured: 1, trending: 0, editors: 0 },
    { name: 'Muji Cotton Bed Sheets', slug: 'muji-cotton-bed-sheets', brand: 'muji', cat: 'home', subcat: 'bedroom', price: null, prev: null, rating: null, reviews: null, desc: 'Organic cotton bed sheets with a soft, washed texture.', why: 'Simple, well-made sheets at a fair price.', bestFor: 'Those who prefer simple, quality bedding', benefits: ['Organic cotton','Gets softer over time','Minimalist design'], pros: ['Very comfortable','Improves with washing','Good value'], cons: ['Wrinkles easily','Colors are muted'], featured: 0, trending: 0, editors: 0 },
    { name: 'Aesop Parsley Seed Cleanser', slug: 'aesop-parsley-seed-cleanser', brand: 'aesop', cat: 'beauty', subcat: 'skincare', price: null, prev: null, rating: null, reviews: null, desc: 'Gentle gel cleanser with parsley seed, grape seed, and green tea.', why: 'A gentle daily cleanser that leaves skin clean without stripping.', bestFor: 'Normal to combination skin', benefits: ['Antioxidant-rich formula','Gentle cleansing','Pleasant herbal scent'], pros: ['Very gentle','Nice consistency','Effective cleansing'], cons: ['Expensive for a cleanser'], featured: 0, trending: 0, editors: 1 },
    { name: 'Le Creuset Stoneware Mug', slug: 'le-creuset-stoneware-mug', brand: 'le-creuset', cat: 'home', subcat: 'kitchen', price: null, prev: null, rating: null, reviews: null, desc: 'Dense stoneware mug that keeps drinks hotter for longer.', why: 'A small daily luxury that elevates your morning routine.', bestFor: 'Coffee and tea lovers', benefits: ['Excellent heat retention','Chip-resistant stoneware','Dishwasher safe','Beautiful colors'], pros: ['Keeps drinks hot','Very durable','Beautiful colors'], cons: ['Heavier than typical mugs','Pricey for a mug'], featured: 0, trending: 1, editors: 0 },
    { name: 'Bang & Olufsen Beosound A1', slug: 'bang-olufsen-beosound-a1', brand: 'bang-olufsen', cat: 'electronics', subcat: 'audio', price: null, prev: null, rating: null, reviews: null, desc: 'Portable Bluetooth speaker with true360 omnidirectional sound.', why: 'One of the best-sounding portable speakers at any price.', bestFor: 'Music lovers who want premium portable audio', benefits: ['True360 sound','IP67 waterproof','18-hour battery'], pros: ['Exceptional sound for size','Beautiful design','Waterproof'], cons: ['Expensive','Bass limited by size'], featured: 0, trending: 0, editors: 1 },
    { name: 'Muji Travel Organizer Set', slug: 'muji-travel-organizer-set', brand: 'muji', cat: 'travel', subcat: 'travel-accessories', price: null, prev: null, rating: null, reviews: null, desc: 'Set of mesh and nylon organizer pouches for packing.', why: 'Simple, functional, and well-priced.', bestFor: 'Organized packers who prefer minimal design', benefits: ['Lightweight mesh','Multiple sizes','Easy to pack'], pros: ['Very lightweight','Practical sizing','Great value'], cons: ['Thin material','Basic zippers'], featured: 0, trending: 0, editors: 0 },
    { name: 'Aesop Reverence Hand Balm', slug: 'aesop-reverence-hand-balm', brand: 'aesop', cat: 'beauty', subcat: 'skincare', price: null, prev: null, rating: null, reviews: null, desc: 'Rich, nourishing hand balm with vetiver root and petitgrain.', why: 'A genuinely effective hand balm with a grounding, earthy scent.', bestFor: 'Those with dry hands', benefits: ['Rich moisturizing','Non-greasy','Calming scent'], pros: ['Deeply moisturizing','Beautiful scent','Absorbs quickly'], cons: ['Pricey','Small tube'], featured: 0, trending: 0, editors: 0 },
    { name: 'Le Creuset Skillet 10.25"', slug: 'le-creuset-skillet', brand: 'le-creuset', cat: 'home', subcat: 'kitchen', price: null, prev: null, rating: null, reviews: null, desc: 'Cast iron skillet with enamel interior.', why: 'A versatile pan that handles everything from searing to baking.', bestFor: 'Home cooks who want versatile cast iron', benefits: ['No seasoning needed','Superior heat retention','Easy to clean enamel'], pros: ['Excellent searing','Easy maintenance','Beautiful design'], cons: ['Heavy','Expensive'], featured: 1, trending: 0, editors: 0 },
    { name: 'Away Everywhere Bag', slug: 'away-everywhere-bag', brand: 'away', cat: 'travel', subcat: 'travel-accessories', price: null, prev: null, rating: null, reviews: null, desc: 'Versatile travel bag that works as a personal item or weekender.', why: 'A thoughtfully designed travel bag with smart organization.', bestFor: 'Travelers who need a versatile personal item', benefits: ['Fits under airplane seats','Multiple compartments','Laptop sleeve'], pros: ['Great organization','Sturdy construction','Versatile use'], cons: ['Pricey','Stiff when new'], featured: 0, trending: 0, editors: 0 },
    { name: 'Muji LED Desk Lamp', slug: 'muji-led-desk-lamp', brand: 'muji', cat: 'home', subcat: 'lighting', price: null, prev: null, rating: null, reviews: null, desc: 'Minimalist LED desk lamp with adjustable brightness.', why: 'Clean design that disappears into any workspace.', bestFor: 'Minimalists who want a simple desk lamp', benefits: ['Adjustable brightness','Color temperature control','USB charging port'], pros: ['Clean design','Good light quality','Energy efficient'], cons: ['Base could be heavier','Limited reach'], featured: 0, trending: 0, editors: 0 },
    { name: 'Bang & Olufsen Beoplay EX', slug: 'bang-olufsen-beoplay-ex', brand: 'bang-olufsen', cat: 'electronics', subcat: 'audio', price: null, prev: null, rating: null, reviews: null, desc: 'Premium wireless earbuds with adaptive noise cancellation.', why: 'The best-sounding true wireless earbuds we have tested.', bestFor: 'Audio enthusiasts', benefits: ['Adaptive ANC','Crystal-clear calls','IP57 protection'], pros: ['Outstanding sound quality','Effective ANC','Comfortable fit'], cons: ['Expensive','Average battery life'], featured: 0, trending: 1, editors: 0 },
    { name: 'Aesop Geranium Leaf Body Cleanser', slug: 'aesop-geranium-body-cleanser', brand: 'aesop', cat: 'beauty', subcat: 'skincare', price: null, prev: null, rating: null, reviews: null, desc: 'Low-foam gel body cleanser with geranium leaf and bergamot.', why: 'Transforms a daily shower into something genuinely pleasant.', bestFor: 'Those looking to upgrade their shower routine', benefits: ['Gentle botanical formula','Subtle lasting scent','Non-drying'], pros: ['Luxurious experience','Great scent','Gentle on skin'], cons: ['Very expensive','Runs out quickly'], featured: 0, trending: 0, editors: 0 },
    { name: 'Muji Stainless Steel Tumbler', slug: 'muji-stainless-steel-tumbler', brand: 'muji', cat: 'home', subcat: 'kitchen', price: null, prev: null, rating: null, reviews: null, desc: 'Slim, double-walled stainless steel tumbler.', why: 'Clean, reliable tumbler that keeps drinks at temperature for hours.', bestFor: 'Daily commuters', benefits: ['Double-wall insulation','Slim design','Leak-proof lid'], pros: ['Fits in bags easily','Good insulation','Affordable'], cons: ['Small capacity','Hand wash only'], featured: 0, trending: 0, editors: 0 },
    { name: 'Le Creuset Salt & Pepper Mills', slug: 'le-creuset-salt-pepper-mills', brand: 'le-creuset', cat: 'home', subcat: 'kitchen', price: null, prev: null, rating: null, reviews: null, desc: 'Stoneware salt and pepper mills with carbon steel mechanism.', why: 'Good-looking mills with reliable grind mechanisms.', bestFor: 'Le Creuset enthusiasts', benefits: ['Adjustable grind','Carbon steel mechanism','Beautiful design'], pros: ['Great looking','Reliable grinding','Sturdy build'], cons: ['Expensive for mills','Small capacity'], featured: 0, trending: 0, editors: 0 },
    { name: 'Away Toiletry Bag', slug: 'away-toiletry-bag', brand: 'away', cat: 'travel', subcat: 'travel-accessories', price: null, prev: null, rating: null, reviews: null, desc: 'Water-resistant toiletry bag with smart compartments.', why: 'Well-organized with a useful hanging hook.', bestFor: 'Travelers who want an organized toiletry bag', benefits: ['Water-resistant','Hanging hook','Multiple compartments'], pros: ['Good organization','Durable material','Easy to clean'], cons: ['Pricey','Hook could be stronger'], featured: 0, trending: 0, editors: 0 },
    { name: 'Muji Ultrasonic Humidifier', slug: 'muji-ultrasonic-humidifier', brand: 'muji', cat: 'home', subcat: 'decor', price: null, prev: null, rating: null, reviews: null, desc: 'Quiet ultrasonic humidifier in signature minimal white.', why: 'Reliable, quiet, and visually unobtrusive.', bestFor: 'Those who want effective humidification', benefits: ['Ultra-quiet','Auto shut-off','Adjustable mist'], pros: ['Very quiet','Clean design','Effective output'], cons: ['Small tank','No humidity sensor'], featured: 0, trending: 0, editors: 0 },
  ];
